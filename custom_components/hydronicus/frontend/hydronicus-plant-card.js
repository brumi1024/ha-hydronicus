var A="hydronicus-plant-card";var G=`custom:${A}`;var ee="hydronicus/list_plants";var ne=["comfortable","compact"];function J(r){if(!r||typeof r!=="object"){throw new Error("Hydronicus Plant card requires a configuration.")}const t=r;if(t.type!==G){throw new Error(`Hydronicus Plant card type must be ${G}.`)}if(typeof t.plant!=="string"){throw new Error("Hydronicus Plant card requires one Plant UUID in `plant`.")}const e=t.density??"comfortable";if(!ne.includes(e)){throw new Error("Hydronicus Plant card density must be comfortable or compact.")}return{type:G,plant:t.plant.trim(),density:e}}var K=class{plants=[];pending=null;connection=null;get known(){return this.plants}load(t){if(this.connection===t&&this.pending)return this.pending;this.connection=t;this.pending=t.sendMessagePromise({type:ee}).then(e=>{this.plants=Array.isArray(e.plants)?e.plants:[];return this.plants}).catch(()=>{if(this.connection===t)this.pending=null;return this.plants});return this.pending}async settled(t=2e3){if(!this.pending)return this.plants;let e;const n=new Promise(s=>{e=setTimeout(()=>s(this.plants),t)});try{return await Promise.race([this.pending,n])}finally{clearTimeout(e)}}reset(){this.plants=[];this.pending=null;this.connection=null}};var H=new K;async function vt(r){const t=r?.connection?await H.load(r.connection):H.known;return{plant:t[0]?.id??"",density:"comfortable"}}var re={plant:"Hydronicus Plant",density:"Density"};var se={plant:"The Plant this card shows. Only Plants you can read are listed; one that is not listed shows its UUID.",density:"Compact uses less spacing for dense dashboards."};function ie(r){if(r.length===0)return{text:{}};return{select:{mode:"dropdown",options:r.map(t=>({value:t.id,label:t.name}))}}}async function _t(){const r=await H.settled();return{schema:[{name:"plant",required:true,selector:ie(r)},{name:"density",selector:{select:{mode:"dropdown",options:[{value:"comfortable",label:"Comfortable"},{value:"compact",label:"Compact"}]}}}],computeLabel:t=>re[t.name],computeHelper:t=>se[t.name],assertConfig:t=>{J(t)}}}var $=class extends Event{constructor(t,e,n,s){super("context-request",{bubbles:true,composed:true}),this.context=t,this.contextTarget=e,this.callback=n,this.subscribe=s??false}};function E(r){return r}var b=class{constructor(t,e,n,s){if(this.subscribe=false,this.provided=false,this.value=void 0,this.t=(i,o)=>{this.unsubscribe&&(this.unsubscribe!==o&&(this.provided=false,this.unsubscribe()),this.subscribe||this.unsubscribe()),this.value=i,this.host.requestUpdate(),this.provided&&!this.subscribe||(this.provided=true,this.callback&&this.callback(i,o)),this.unsubscribe=o},this.host=t,void 0!==e.context){const i=e;this.context=i.context,this.callback=i.callback,this.subscribe=i.subscribe??false}else this.context=e,this.callback=n,this.subscribe=s??false;this.host.addController(this)}hostConnected(){this.dispatchRequest()}hostDisconnected(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=void 0)}dispatchRequest(){this.host.dispatchEvent(new $(this.context,this.host,this.t,this.subscribe))}};var I=globalThis;var j=I.ShadowRoot&&(void 0===I.ShadyCSS||I.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype;var Q=Symbol();var xt=new WeakMap;var R=class{constructor(t,e,n){if(this._$cssResult$=true,n!==Q)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(j&&void 0===t){const n=void 0!==e&&1===e.length;n&&(t=xt.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),n&&xt.set(e,t))}return t}toString(){return this.cssText}};var $t=r=>new R("string"==typeof r?r:r+"",void 0,Q);var tt=(r,...t)=>{const e=1===r.length?r[0]:t.reduce((n,s,i)=>n+(o=>{if(true===o._$cssResult$)return o.cssText;if("number"==typeof o)return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+r[i+1],r[0]);return new R(e,r,Q)};var kt=(r,t)=>{if(j)r.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of t){const n=document.createElement("style"),s=I.litNonce;void 0!==s&&n.setAttribute("nonce",s),n.textContent=e.cssText,r.appendChild(n)}};var et=j?r=>r:r=>r instanceof CSSStyleSheet?(t=>{let e="";for(const n of t.cssRules)e+=n.cssText;return $t(e)})(r):r;var{is:ae,defineProperty:le,getOwnPropertyDescriptor:ce,getOwnPropertyNames:de,getOwnPropertySymbols:ue,getPrototypeOf:he}=Object;var V=globalThis;var wt=V.trustedTypes;var pe=wt?wt.emptyScript:"";var me=V.reactiveElementPolyfillSupport;var U=(r,t)=>r;var nt={toAttribute(r,t){switch(t){case Boolean:r=r?pe:null;break;case Object:case Array:r=null==r?r:JSON.stringify(r)}return r},fromAttribute(r,t){let e=r;switch(t){case Boolean:e=null!==r;break;case Number:e=null===r?null:Number(r);break;case Object:case Array:try{e=JSON.parse(r)}catch(n){e=null}}return e}};var Ct=(r,t)=>!ae(r,t);var St={attribute:true,type:String,converter:nt,reflect:false,useDefault:false,hasChanged:Ct};Symbol.metadata??=Symbol("metadata"),V.litPropertyMetadata??=new WeakMap;var y=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=St){if(e.state&&(e.attribute=false),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=true),this.elementProperties.set(t,e),!e.noAccessor){const n=Symbol(),s=this.getPropertyDescriptor(t,n,e);void 0!==s&&le(this.prototype,t,s)}}static getPropertyDescriptor(t,e,n){const{get:s,set:i}=ce(this.prototype,t)??{get(){return this[e]},set(o){this[e]=o}};return{get:s,set(o){const d=s?.call(this);i?.call(this,o),this.requestUpdate(t,d,n)},configurable:true,enumerable:true}}static getPropertyOptions(t){return this.elementProperties.get(t)??St}static _$Ei(){if(this.hasOwnProperty(U("elementProperties")))return;const t=he(this);t.finalize(),void 0!==t.l&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(U("finalized")))return;if(this.finalized=true,this._$Ei(),this.hasOwnProperty(U("properties"))){const e=this.properties,n=[...de(e),...ue(e)];for(const s of n)this.createProperty(s,e[s])}const t=this[Symbol.metadata];if(null!==t){const e=litPropertyMetadata.get(t);if(void 0!==e)for(const[n,s]of e)this.elementProperties.set(n,s)}this._$Eh=new Map;for(const[e,n]of this.elementProperties){const s=this._$Eu(e,n);void 0!==s&&this._$Eh.set(s,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const n=new Set(t.flat(1/0).reverse());for(const s of n)e.unshift(et(s))}else void 0!==t&&e.push(et(t));return e}static _$Eu(t,e){const n=e.attribute;return false===n?void 0:"string"==typeof n?n:"string"==typeof t?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=false,this.hasUpdated=false,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),void 0!==this.renderRoot&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const n of e.keys())this.hasOwnProperty(n)&&(t.set(n,this[n]),delete this[n]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return kt(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(true),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,n){this._$AK(t,n)}_$ET(t,e){const n=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,n);if(void 0!==s&&true===n.reflect){const i=(void 0!==n.converter?.toAttribute?n.converter:nt).toAttribute(e,n.type);this._$Em=t,null==i?this.removeAttribute(s):this.setAttribute(s,i),this._$Em=null}}_$AK(t,e){const n=this.constructor,s=n._$Eh.get(t);if(void 0!==s&&this._$Em!==s){const i=n.getPropertyOptions(s),o="function"==typeof i.converter?{fromAttribute:i.converter}:void 0!==i.converter?.fromAttribute?i.converter:nt;this._$Em=s;const d=o.fromAttribute(e,i.type);this[s]=d??this._$Ej?.get(s)??d,this._$Em=null}}requestUpdate(t,e,n,s=false,i){if(void 0!==t){const o=this.constructor;if(false===s&&(i=this[t]),n??=o.getPropertyOptions(t),!((n.hasChanged??Ct)(i,e)||n.useDefault&&n.reflect&&i===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,n))))return;this.C(t,e,n)}false===this.isUpdatePending&&(this._$ES=this._$EP())}C(t,e,{useDefault:n,reflect:s,wrapped:i},o){n&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,o??e??this[t]),true!==i||void 0!==o)||(this._$AL.has(t)||(this.hasUpdated||n||(e=void 0),this._$AL.set(t,e)),true===s&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=true;try{await this._$ES}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[s,i]of this._$Ep)this[s]=i;this._$Ep=void 0}const n=this.constructor.elementProperties;if(n.size>0)for(const[s,i]of n){const{wrapped:o}=i,d=this[s];true!==o||this._$AL.has(s)||void 0===d||this.C(s,void 0,i,d)}}let t=false;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(e)):this._$EM()}catch(n){throw t=false,this._$EM(),n}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=true,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=false}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return true}update(t){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(t){}firstUpdated(t){}};y.elementStyles=[],y.shadowRootOptions={mode:"open"},y[U("elementProperties")]=new Map,y[U("finalized")]=new Map,me?.({ReactiveElement:y}),(V.reactiveElementVersions??=[]).push("2.1.2");var ct=globalThis;var At=r=>r;var Z=ct.trustedTypes;var Et=Z?Z.createPolicy("lit-html",{createHTML:r=>r}):void 0;var Ut="$lit$";var _=`lit$${Math.random().toFixed(9).slice(2)}$`;var Lt="?"+_;var ge=`<${Lt}>`;var S=document;var M=()=>S.createComment("");var q=r=>null===r||"object"!=typeof r&&"function"!=typeof r;var dt=Array.isArray;var fe=r=>dt(r)||"function"==typeof r?.[Symbol.iterator];var rt="[ 	\n\f\r]";var L=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;var Pt=/-->/g;var Tt=/>/g;var k=RegExp(`>|${rt}(?:([^\\s"'>=/]+)(${rt}*=${rt}*(?:[^
\f\r"'\`<>=]|("|')|))|$)`,"g");var zt=/'/g;var Ht=/"/g;var Mt=/^(?:script|style|textarea|title)$/i;var ut=r=>(t,...e)=>({_$litType$:r,strings:t,values:e});var a=ut(1);var gn=ut(2);var fn=ut(3);var C=Symbol.for("lit-noChange");var c=Symbol.for("lit-nothing");var Rt=new WeakMap;var w=S.createTreeWalker(S,129);function qt(r,t){if(!dt(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==Et?Et.createHTML(t):t}var be=(r,t)=>{const e=r.length-1,n=[];let s,i=2===t?"<svg>":3===t?"<math>":"",o=L;for(let d=0;d<e;d++){const l=r[d];let h,p,u=-1,f=0;for(;f<l.length&&(o.lastIndex=f,p=o.exec(l),null!==p);)f=o.lastIndex,o===L?"!--"===p[1]?o=Pt:void 0!==p[1]?o=Tt:void 0!==p[2]?(Mt.test(p[2])&&(s=RegExp("</"+p[2],"g")),o=k):void 0!==p[3]&&(o=k):o===k?">"===p[0]?(o=s??L,u=-1):void 0===p[1]?u=-2:(u=o.lastIndex-p[2].length,h=p[1],o=void 0===p[3]?k:'"'===p[3]?Ht:zt):o===Ht||o===zt?o=k:o===Pt||o===Tt?o=L:(o=k,s=void 0);const v=o===k&&r[d+1].startsWith("/>")?" ":"";i+=o===L?l+ge:u>=0?(n.push(h),l.slice(0,u)+Ut+l.slice(u)+_+v):l+_+(-2===u?d:v)}return[qt(r,i+(r[e]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),n]};var O=class r{constructor({strings:t,_$litType$:e},n){let s;this.parts=[];let i=0,o=0;const d=t.length-1,l=this.parts,[h,p]=be(t,e);if(this.el=r.createElement(h,n),w.currentNode=this.el.content,2===e||3===e){const u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;null!==(s=w.nextNode())&&l.length<d;){if(1===s.nodeType){if(s.hasAttributes())for(const u of s.getAttributeNames())if(u.endsWith(Ut)){const f=p[o++],v=s.getAttribute(u).split(_),F=/([.?@])?(.*)/.exec(f);l.push({type:1,index:i,name:F[2],strings:v,ctor:"."===F[1]?it:"?"===F[1]?ot:"@"===F[1]?at:T}),s.removeAttribute(u)}else u.startsWith(_)&&(l.push({type:6,index:i}),s.removeAttribute(u));if(Mt.test(s.tagName)){const u=s.textContent.split(_),f=u.length-1;if(f>0){s.textContent=Z?Z.emptyScript:"";for(let v=0;v<f;v++)s.append(u[v],M()),w.nextNode(),l.push({type:2,index:++i});s.append(u[f],M())}}}else if(8===s.nodeType)if(s.data===Lt)l.push({type:2,index:i});else{let u=-1;for(;-1!==(u=s.data.indexOf(_,u+1));)l.push({type:7,index:i}),u+=_.length-1}i++}}static createElement(t,e){const n=S.createElement("template");return n.innerHTML=t,n}};function P(r,t,e=r,n){if(t===C)return t;let s=void 0!==n?e._$Co?.[n]:e._$Cl;const i=q(t)?void 0:t._$litDirective$;return s?.constructor!==i&&(s?._$AO?.(false),void 0===i?s=void 0:(s=new i(r),s._$AT(r,e,n)),void 0!==n?(e._$Co??=[])[n]=s:e._$Cl=s),void 0!==s&&(t=P(r,s._$AS(r,t.values),s,n)),t}var st=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:n}=this._$AD,s=(t?.creationScope??S).importNode(e,true);w.currentNode=s;let i=w.nextNode(),o=0,d=0,l=n[0];for(;void 0!==l;){if(o===l.index){let h;2===l.type?h=new N(i,i.nextSibling,this,t):1===l.type?h=new l.ctor(i,l.name,l.strings,this,t):6===l.type&&(h=new lt(i,this,t)),this._$AV.push(h),l=n[++d]}o!==l?.index&&(i=w.nextNode(),o++)}return w.currentNode=S,s}p(t){let e=0;for(const n of this._$AV)void 0!==n&&(void 0!==n.strings?(n._$AI(t,n,e),e+=n.strings.length-2):n._$AI(t[e])),e++}};var N=class r{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,n,s){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=n,this.options=s,this._$Cv=s?.isConnected??true}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=P(this,t,e),q(t)?t===c||null==t||""===t?(this._$AH!==c&&this._$AR(),this._$AH=c):t!==this._$AH&&t!==C&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):fe(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==c&&q(this._$AH)?this._$AA.nextSibling.data=t:this.T(S.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:n}=t,s="number"==typeof n?this._$AC(t):(void 0===n.el&&(n.el=O.createElement(qt(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===s)this._$AH.p(e);else{const i=new st(s,this),o=i.u(this.options);i.p(e),this.T(o),this._$AH=i}}_$AC(t){let e=Rt.get(t.strings);return void 0===e&&Rt.set(t.strings,e=new O(t)),e}k(t){dt(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let n,s=0;for(const i of t)s===e.length?e.push(n=new r(this.O(M()),this.O(M()),this,this.options)):n=e[s],n._$AI(i),s++;s<e.length&&(this._$AR(n&&n._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(false,true,e);t!==this._$AB;){const n=At(t).nextSibling;At(t).remove(),t=n}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}};var T=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,n,s,i){this.type=1,this._$AH=c,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=i,n.length>2||""!==n[0]||""!==n[1]?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=c}_$AI(t,e=this,n,s){const i=this.strings;let o=false;if(void 0===i)t=P(this,t,e,0),o=!q(t)||t!==this._$AH&&t!==C,o&&(this._$AH=t);else{const d=t;let l,h;for(t=i[0],l=0;l<i.length-1;l++)h=P(this,d[n+l],e,l),h===C&&(h=this._$AH[l]),o||=!q(h)||h!==this._$AH[l],h===c?t=c:t!==c&&(t+=(h??"")+i[l+1]),this._$AH[l]=h}o&&!s&&this.j(t)}j(t){t===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}};var it=class extends T{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===c?void 0:t}};var ot=class extends T{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==c)}};var at=class extends T{constructor(t,e,n,s,i){super(t,e,n,s,i),this.type=5}_$AI(t,e=this){if((t=P(this,t,e,0)??c)===C)return;const n=this._$AH,s=t===c&&n!==c||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,i=t!==c&&(n===c||s);s&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}};var lt=class{constructor(t,e,n){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(t){P(this,t)}};var ye=ct.litHtmlPolyfillSupport;ye?.(O,N),(ct.litHtmlVersions??=[]).push("3.3.3");var Ot=(r,t,e)=>{const n=e?.renderBefore??t;let s=n._$litPart$;if(void 0===s){const i=e?.renderBefore??null;n._$litPart$=s=new N(t.insertBefore(M(),i),i,void 0,e??{})}return s._$AI(r),s};var ht=globalThis;var x=class extends y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ot(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(true)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(false)}render(){return C}};x._$litElement$=true,x["finalized"]=true,ht.litElementHydrateSupport?.({LitElement:x});var ve=ht.litElementPolyfillSupport;ve?.({LitElement:x});(ht.litElementVersions??=[]).push("4.2.2");var z="\xB0C";var _e=5;var xe=35;function pt(r){return r?.temperature==="\xB0F"?"\xB0F":z}function B(r,t){return t==="\xB0F"?r*9/5+32:r}function $e(r,t){return t==="\xB0F"?r*9/5:r}function mt(r){return r==="\xB0F"?1:.5}function Dt(r,t,e){const n=mt(e);const s=B(r,e);const i=s/n;const o=(t>0?Math.floor(i+1e-9)+1:Math.ceil(i-1e-9)-1)*n;const d=B(_e,e);const l=B(xe,e);return Number(Math.min(l,Math.max(d,o)).toFixed(1))}function ke(r){switch(r?.number_format){case"comma_decimal":return["en-US","en"];case"decimal_comma":return["de","es","it"];case"space_comma":return["fr","sv","cs"];case"quote_decimal":return["de-CH"];case"system":return void 0;case"none":return"en-US";default:return r?.language}}var Nt=new Map;function g(r,t,e=1){const n=ke(t);const s=t?.number_format!=="none";const i=`${JSON.stringify(n)}|${e}|${s}`;let o=Nt.get(i);if(!o){try{o=new Intl.NumberFormat(n,{minimumFractionDigits:e,maximumFractionDigits:e,useGrouping:s})}catch{o=new Intl.NumberFormat(void 0,{minimumFractionDigits:e,maximumFractionDigits:e})}Nt.set(i,o)}return o.format(r)}function gt(r,t,e){return g(B(r,t),e)}function Ft(r,t,e){return g($e(r,t),e)}var we=2;var Se=new Set(["active","cooling","heating","open","opening","overrun","ready","requested","running","selected","starting","waiting"]);function It(r){if(!r||typeof r!=="object"){throw new Error("Hydronicus returned no Plant snapshot.")}const t=r;if(t.schema_version!==we){throw new Error(`Unsupported Hydronicus snapshot schema: ${String(t.schema_version)}.`)}if(!t.plant||!Array.isArray(t.zones)||!Array.isArray(t.alerts)){throw new Error("Hydronicus returned an incomplete Plant snapshot.")}return t}function jt(r){return[...r.alerts].sort((t,e)=>t.priority-e.priority||t.code.localeCompare(e.code)||t.scope.localeCompare(e.scope))}function Vt(r){const t=r.plant.health.toLowerCase();const e=r.alerts.some(s=>s.severity==="critical"||s.severity==="error");if(r.safe_shutdown.active||e||["blocked","critical","error","failed","unhealthy"].includes(t)){return"attention"}const n=`${r.plant.active_mode} ${r.plant.status}`.toLowerCase();if(n.includes("cool"))return"cooling";if(n.includes("heat"))return"heating";return"idle"}function ft(r){return Se.has(r.toLowerCase())}function Zt(r,t){if(r.thermostat.kind!=="hydronicus"||!r.thermostat.control_entity_id)return null;return{domain:"climate",service:"set_temperature",data:{entity_id:r.thermostat.control_entity_id,temperature:t}}}function Bt(r,t){if(r.thermostat.kind!=="hydronicus"||!r.thermostat.control_entity_id)return null;return{domain:"climate",service:"set_preset_mode",data:{entity_id:r.thermostat.control_entity_id,preset_mode:t}}}function Wt(r,t){if(!r.controls.requested_mode)return null;return{domain:"select",service:"select_option",data:{entity_id:r.controls.requested_mode,option:t}}}function Xt(r){if(!r.controls.safe_shutdown)return null;return{domain:"button",service:"press",data:{entity_id:r.controls.safe_shutdown}}}function Yt(r){const t=String(r.action??"operation").replaceAll("_"," ");const e=String(r.actuator_name??"actuator");const n=String(r.result??"");if(n==="proposed")return`Would ${t} ${e}`;if(n==="executed")return`Executed ${e} ${t}`;if(n==="suppressed")return`Suppressed ${e} ${t}`;return`${n||"Operation"}: ${e} ${t}`}function m(r){return r.replaceAll("_"," ")}function D(r,t,e){const[n,s]=t.split(".");return r?.(`component.hydronicus.entity.${n}.${s}.state.${e}`)||m(e)}function Gt(r){return[...new Set(r.thermostat.preset_modes)].filter(t=>t!=="none")}function Kt(r,t,e=z){if(r.thermostat.target_temperature===null)return null;return Dt(r.thermostat.target_temperature,t,e)}var Ce="hydronicus/subscribe_plant";var Ae=1e3;var Ee=6e4;var Pe={setTimeout:(r,t)=>globalThis.setTimeout(r,t),clearTimeout:r=>globalThis.clearTimeout(r)};function Te(r){return typeof r==="object"&&r!==null&&"code"in r?String(r.code):void 0}function X(r,t){if(r instanceof Error)return r.message;if(typeof r==="object"&&r!==null&&"message"in r&&r.message){return String(r.message)}return t}function bt(r){if(!r)return;try{void Promise.resolve(r()).catch(()=>void 0)}catch{}}var W=class{constructor(t,e=Pe){this.host=t;this.scheduler=e}host;scheduler;connection;plantId;generation=0;unsubscribe;retryHandle;attempt=0;current={kind:"idle"};get status(){return this.current}connect(t,e){if(t===this.connection&&e===this.plantId)return;this.disconnect();if(!t||!e)return;this.connection=t;this.plantId=e;t.addEventListener?.("disconnected",this.handleDisconnected);t.addEventListener?.("ready",this.handleReady);this.subscribe()}disconnect(){this.cancelRetry();this.generation+=1;bt(this.unsubscribe);this.unsubscribe=void 0;this.connection?.removeEventListener?.("disconnected",this.handleDisconnected);this.connection?.removeEventListener?.("ready",this.handleReady);this.connection=void 0;this.plantId=void 0;this.attempt=0;this.setStatus({kind:"idle"})}subscribe(){const t=this.connection;const e=this.plantId;if(!t||!e)return;this.cancelRetry();const n=++this.generation;if(this.current.kind!=="reconnecting"&&this.current.kind!=="retrying"){this.setStatus({kind:"connecting"})}t.subscribeMessage(s=>this.handleEvent(n,s),{type:Ce,plant_id:e},{resubscribe:false}).then(s=>{if(n!==this.generation){bt(s);return}this.unsubscribe=s}).catch(s=>{if(n!==this.generation)return;this.handleError(s)})}handleEvent(t,e){if(t!==this.generation)return;if(e.snapshot!==void 0&&e.snapshot!==null){this.attempt=0;this.setStatus({kind:"live"});this.host.onSnapshot(e.snapshot);return}if(e.status==="unavailable")this.setStatus({kind:"unavailable"});else if(e.status==="unauthorized")this.stop({kind:"unauthorized"});else if(e.status==="plant_not_found")this.stop({kind:"not_found"})}handleError(t){const e=Te(t);if(e==="plant_not_found"){this.stop({kind:"not_found"});return}if(e==="unauthorized"){this.stop({kind:"unauthorized"});return}const n=Math.min(Ae*2**this.attempt,Ee);this.attempt+=1;this.setStatus({kind:"retrying",attempt:this.attempt,delayMs:n,message:X(t,"The Hydronicus Plant stream failed.")});this.retryHandle=this.scheduler.setTimeout(()=>{this.retryHandle=void 0;this.subscribe()},n)}stop(t){this.cancelRetry();this.generation+=1;bt(this.unsubscribe);this.unsubscribe=void 0;this.setStatus(t)}handleDisconnected=()=>{this.cancelRetry();this.generation+=1;this.unsubscribe=void 0;this.setStatus({kind:"reconnecting"})};handleReady=()=>{this.attempt=0;this.subscribe()};cancelRetry(){if(this.retryHandle!==void 0)this.scheduler.clearTimeout(this.retryHandle);this.retryHandle=void 0}setStatus(t){this.current=t;this.host.onStatus(t)}};var Jt=tt`
  :host {
    display: block;
...
`;var yt=["auto","idle","heating","cooling"];var ze=1200;var He=E("hassConnection");var Re=E("hassApi");var Ue=E("hassConfig");var Le=E("hassInternationalization");function Me(r){return r.replaceAll("_","-")}var Y=class extends x{static properties={preview:{type:Boolean},_config:{state:true},_connection:{state:true},_unit:{state:true},_locale:{state:true},_localize:{state:true},_snapshot:{state:true},_snapshotError:{state:true},_stream:{state:true},_actionError:{state:true},_holdingShutdown:{state:true}};static styles=Jt;_hass;_callService;_fromContext=new Set;_plantStream;_holdTimer=null;constructor(){super();this.preview=false;this._config=void 0;this._connection=void 0;this._unit=z;this._locale=void 0;this._localize=void 0;this._snapshot=null;this._snapshotError=null;this._stream={kind:"idle"};this._actionError=null;this._holdingShutdown=false;this._plantStream=new W({onStatus:t=>this._streamStatusChanged(t),onSnapshot:t=>this._snapshotReceived(t)});new b(this,{context:He,subscribe:true,callback:t=>{this._fromContext.add("connection");this._connection=t?.connection}});new b(this,{context:Re,subscribe:true,callback:t=>{this._fromContext.add("api");this._callService=t?.callService}});new b(this,{context:Ue,subscribe:true,callback:t=>{this._fromContext.add("config");this._unit=pt(t?.config?.unit_system)}});new b(this,{context:Le,subscribe:true,callback:t=>{this._fromContext.add("i18n");this._locale=t?.locale??(t?.language?{language:t.language}:void 0);this._localize=t?.localize}})}set hass(t){this._hass=t;if(!this._fromContext.has("connection"))this._connection=t?.connection;if(!this._fromContext.has("api"))this._callService=t?(...e)=>t.callService(...e):void 0;if(!this._fromContext.has("config"))this._unit=pt(t?.config?.unit_system);if(!this._fromContext.has("i18n")){this._locale=t?.locale??(t?.language?{language:t.language}:void 0);this._localize=t?.localize}}get hass(){return this._hass}static async getConfigForm(){return _t()}static async getStubConfig(t){return vt(t)}setConfig(t){const e=J(t);if(e.plant!==this._config?.plant){this._snapshot=null;this._snapshotError=null;this._actionError=null}this._config=e}getCardSize(){const t=this._snapshot;if(!t)return 4;let e=4;const n=Math.min(t.alerts.length,3);if(n)e+=1+n;e+=1+Math.max(1,t.zones.length)*5;if(t.delivery_paths.length)e+=1+t.delivery_paths.length*3;if(t.actuators.length)e+=1+t.actuators.length*2;e+=1;const s=Object.values(t.execution.operations).flat().length;if(s)e+=1+s;return e}getGridOptions(){return{columns:12,min_columns:6}}connectedCallback(){super.connectedCallback();this.requestUpdate()}disconnectedCallback(){this._plantStream.disconnect();this._clearHold();super.disconnectedCallback()}updated(t){super.updated(t);this._syncSelectValues();if(!this.isConnected)return;const e=this._config?.plant||void 0;this._plantStream.connect(this._connection,e);if(this._connection&&(t.has("_connection")||this.preview))void H.load(this._connection)}_syncSelectValues(){for(const t of this.renderRoot.querySelectorAll("select[data-value]")){const e=t.dataset.value??"";if(t.value!==e)t.value=e}}_streamStatusChanged(t){this._stream=t;if(["idle","unavailable","not_found","unauthorized"].includes(t.kind)){this._snapshot=null;this._clearHold()}}_snapshotReceived(t){try{this._snapshot=It(t);this._snapshotError=null}catch(e){this._snapshot=null;this._snapshotError=X(e,"Unsupported Hydronicus snapshot.")}}render(){const t=this._config;if(!t||!t.plant){return this._renderState("Hydronicus Plant","Select a Hydronicus Plant in the card editor.","status")}if(this._snapshotError){return this._renderState("Card update needed",this._snapshotError,"alert","Reload the browser after upgrading Hydronicus so the card and the integration match.")}const e=this._snapshot;const n=this._stream;if(!e){switch(n.kind){case"not_found":return this._renderState("Plant not found","This Hydronicus Plant was not found. Choose another Plant in the card editor.","alert");case"unauthorized":return this._renderState("No access","You do not have access to this Hydronicus Plant.","alert");case"unavailable":return this._renderState("Plant unavailable","The Hydronicus Plant is unavailable while it loads or after it was unloaded. The card reconnects automatically.","status");case"retrying":return this._renderState("Connection needs attention",n.message,"alert",`Retrying in ${Math.round(n.delayMs/1e3)} s.`);default:return this._renderLoading(n.kind==="reconnecting")}}return a`<ha-card class=${t.density??"comfortable"} data-visual=${Vt(e)}>
      ${this._renderHeader(e)}
      ${this._renderStreamNotice(n)}
      ${this._actionError?a`<div class="action-error" role="alert"><span dir="auto">${this._actionError}</span><button type="button" @click=${this._dismissActionError}>Dismiss</button></div>`:c}
      <div class="boundary" role="status">
        <span class="boundary-orb" aria-hidden="true"></span>
        <p class="boundary-copy" dir="auto"><span class="control-label">Execution boundary</span><strong>${e.plant.execution_boundary.message||`${m(e.plant.execution_boundary.mode)} execution boundary is active.`}</strong></p>
      </div>
      ...
      ${s?a`<p class="meta" dir="auto">${s}</p>`:c}
    ...
    </ha-card>`}_renderStreamNotice(t){if(t.kind==="reconnecting"){return a`<p class="notice" role="status" dir="auto">Reconnecting to Home Assistant… The values below may be out of date.</p>`}if(t.kind==="retrying"){return a`<p class="notice" role="status" dir="auto">${t.message} Retrying in ${Math.round(t.delayMs/1e3)} s. The values below may be out of date.</p>`}return c}_renderHeader(t){const e=t.plant;const n=e.execution_boundary;const s=t.controls.requested_mode;const i=yt.includes(e.requested_mode)?yt:[...yt,e.requested_mode];return a`<header class="header">
      <div class="plant-heading">
        ...
        <div class="header-copy">
          ...
          <div class="status-line">
            <span class="status-primary"><span class="status-dot" aria-hidden="true"></span>${D(this._localize,"sensor.controller_status",e.status)}</span>
            <span class="meta mode-detail">Requested ${D(this._localize,"select.requested_mode",e.requested_mode)} · active ${D(this._localize,"sensor.operating_mode",e.active_mode)}</span>
          </div>
          <p class="meta source-line" dir="auto"><strong>Source</strong> ${e.source.active_name??"none active"} · recommended ${e.source.recommended_name??"none"}</p>
          <p class="meta" dir="auto">${e.controller.mode_explanation||"The controller is starting."}</p>
        </div>
      </div>
      <div class="controls">
        <span class="badge ${Me(n.mode)}"><span class="visually-hidden">Execution boundary: </span>${m(n.mode)}</span>
        <label class="mode-control"><span class="control-label">Mode</span><select aria-label="Requested Plant mode" data-value=${e.requested_mode} ?disabled=${!s} @change=${this._modeChanged}>
          ${i.map(o=>a`<option value=${o}>${D(this._localize,"select.requested_mode",o)}</option>`)}
        </select></label>
      ...
      <p class="meta zone-note" dir="auto">${s?`${t.cooling.demand?"Cooling":"Heating"} demand active`:"No demand"} · ${e.explanation}</p>
      <ul class="diagnostic-list" aria-label="Zone diagnostics">
        <li class="diagnostic-chip" dir="auto">${g(t.sensor_status.usable,this._locale,0)} sensor${t.sensor_status.usable===1?"":"s"} ready</li>
        ${t.sensor_status.optional_excluded?a`<li class="diagnostic-chip warning" dir="auto">${g(t.sensor_status.optional_excluded,this._locale,0)} optional excluded</li>`:c}
        ${t.sensor_status.required_blocking?a`<li class="diagnostic-chip danger" dir="auto">${g(t.sensor_status.required_blocking,this._locale,0)} required blocked</li>`:c}
        ${t.cooling.dew_point===null?c:a`<li class="diagnostic-chip" dir="auto">Dew point ${gt(t.cooling.dew_point,i,this._locale)} ${i}</li>`}
        ${t.cooling.condensation_margin===null?c:a`<li class="diagnostic-chip ${t.cooling.blocked?"danger":""}" dir="auto">Margin ${Ft(t.cooling.condensation_margin,i,this._locale)} ${i}</li>`}
      </ul>
      ${e.preset&&e.preset!=="none"?a`<p class="meta zone-note" dir="auto">Preset: ${m(e.preset)}</p>`:c}
      ${t.blocked_reason?a`<p class="meta zone-note" dir="auto">${t.blocked_reason}</p>`:c}
      ${t.coupling_group_ids.length?a`<p class="meta coupling-note" dir="auto">Coupled delivery - this Zone shares hydraulic equipment.</p>`:c}
      ${n?a`<div class="zone-actions">
            <button type="button" dir="ltr" ?disabled=${!l} aria-label=${`Decrease ${t.name} target by ${o} ${i}`} @click=${()=>this._adjustZone(t,-1)}>−${o}</button>
            <button type="button" dir="ltr" ?disabled=${!l} aria-label=${`Increase ${t.name} target by ${o} ${i}`} @click=${()=>this._adjustZone(t,1)}>+${o}</button>
            ${h.length?a`<select class="preset" data-value=${e.preset??"none"} aria-label=${`${t.name} preset`} ?disabled=${!d} @change=${p=>this._presetChanged(t,p)}>${["none",...h].map(p=>a`<option value=${p}>${m(p)}</option>`)}</select>`:c}
          </div>`:a`<p class="meta" dir="auto">Adjust this thermostat in its owning Home Assistant integration.</p>`}
    </article>`}_renderPaths(t){if(!t.delivery_paths.length)return c;return a`<section aria-labelledby="hydronicus-paths"><div class="section-head"><div class="section-kicker"><h3 id="hydronicus-paths">Hydraulic Flow</h3></div><span class="meta" dir="auto">Zone → Circuit → Valve → Pump → Source</span></div><div class="path-list">${t.delivery_paths.map(e=>a`<article class="path" data-status=${e.status} data-flowing=${String(ft(e.status))}>
      <div class="path-head"><div class="path-heading"><strong>${t.zones.find(n=>n.id===e.zone_id)?.name??e.zone_id}</strong></div><div class="status-line"><span class="state ${e.status}">${m(e.status)}</span>${e.coupled?a`<span class="meta">coupled</span>`:c}</div></div>
      <ol class="path-track" aria-label="Ordered hydraulic delivery path">${e.nodes.map((n,s)=>a`<li class="path-step">${s?a`<span class="flow-link" aria-hidden="true"></span>`:c}<span class="node" data-kind=${n.kind} data-state=${n.state} data-flowing=${String(ft(n.state))}><span class="node-kind">${m(n.kind)}</span><span class="node-name">${n.name}</span><span class="node-state">${m(n.state)}</span></span></li>`)}</ol>
      ${e.problem?a`<p class="meta path-problem" dir="auto">${e.problem}</p>`:c}
    </article>`)}</div></section>`}_renderActuators(t){if(!t.actuators.length)return c;return a`<section aria-labelledby="hydronicus-actuators"><div class="section-head"><div class="section-kicker"><h3 id="hydronicus-actuators">Actuator Ownership</h3></div><span class="meta" dir="auto">Shared consumers stay visible</span></div><div class="actuator-list">${t.actuators.map(e=>a`<article class="actuator" data-state=${e.state}><div class="row"><strong>${e.name}</strong><span class="state actuator-state ${e.state}">${m(e.state)}</span></div><p class="meta" dir="auto">${m(e.kind)} · ${e.reason??"No additional explanation."}</p>${e.active_consumers.length?a`<ul class="consumer-list" aria-label="Active circuit consumers">${e.active_consumers.map(n=>a`<li class="consumer-chip"><strong>${n.name}</strong> · ${n.id}</li>`)}</ul>`:a`<p class="meta zone-note" dir="auto">No active circuit consumers.</p>`}</article>`)}</div></section>`}_renderExplanations(t){return a`<section><details><summary>Controller explanations</summary>${t.explanations.map(e=>a`<div class="operation"><span class="operation-marker" aria-hidden="true"></span><p class="operation-copy" dir="auto"><strong>${m(e.scope)}</strong> · ${e.message}</p></div>`)}</details></section>`}_renderOperations(t){const e=Object.values(t.execution.operations).flat();if(!e.length)return c;return a`<section><details open><summary>Latest operation outcomes (${g(e.length,this._locale,0)})</summary>${e.map(n=>{const s=String(n.result??"unknown");return a`<div class="operation" data-result=${s}><span class="operation-marker" aria-hidden="true"></span><p class="operation-copy" dir="auto"><strong>${Yt(n)}</strong><br><span class="meta">${String(n.reason??n.explanation??"")}</span></p></div>`})}</details></section>`}_moreInfo(t){this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:true,composed:true,detail:{entityId:t}}))}_call(t){const e=this._callService;if(!t||!e)return;e(t.domain,t.service,t.data,void 0,false).then(()=>{this._actionError=null},n=>{this._actionError=X(n,"The Home Assistant action failed.");this.requestUpdate()})}_dismissActionError=()=>{this._actionError=null};_modeChanged=t=>{if(!this._snapshot)return;this._call(Wt(this._snapshot,t.target.value))};_adjustZone(t,e){const n=Kt(t,e,this._unit);if(n!==null)this._call(Zt(t,n))}_presetChanged(t,e){this._call(Bt(t,e.target.value))}_startHold(){if(!this._snapshot||this._holdTimer!==null)return;this._holdingShutdown=true;this._holdTimer=setTimeout(()=>{this._holdTimer=null;this._holdingShutdown=false;if(this._snapshot)this._call(Xt(this._snapshot))},ze)}_clearHold=()=>{if(this._holdTimer!==null)clearTimeout(this._holdTimer);this._holdTimer=null;this._holdingShutdown=false};_pointerHoldStart=t=>{if(t.button!==void 0&&t.button>0)return;this._startHold()};_keyHoldStart=t=>{if(t.key!=="Enter"&&t.key!==" ")return;t.preventDefault();if(!t.repeat)this._startHold()};_keyHoldEnd=t=>{if(t.key==="Enter"||t.key===" ")this._clearHold()};_preventContextMenu=t=>{t.preventDefault()}};function Qt(r){if(!r.get(A))r.define(A,Y)}var te=window.customElements;Qt(te);void te.whenDefined("home-assistant").then(()=>{Qt(window.customElements)});window.customCards=window.customCards??[];if(!window.customCards.some(r=>r.type===A)){window.customCards.push({type:A,name:"Hydronicus Plant",version:"0.1.0-rc.6",description:"Topology-driven Hydronicus Plant status and controls.",preview:true,documentationURL:"https://github.com/brumi1024/ha-hydronicus/blob/main/docs/lovelace.md"})}
