var C="\xB0C";var cn=5;var dn=35;function ge(n){return n?.temperature==="\xB0F"?"\xB0F":C}function K(n,e){return e==="\xB0F"?n*9/5+32:n}function un(n,e){return e==="\xB0F"?n*9/5:n}function ye(n){return n==="\xB0F"?1:.5}function Qe(n,e,t){const r=ye(t);const o=K(n,t);const i=o/r;const s=(e>0?Math.floor(i+1e-9)+1:Math.ceil(i-1e-9)-1)*r;const u=K(cn,t);const l=K(dn,t);return Number(Math.min(l,Math.max(u,s)).toFixed(1))}function hn(n){switch(n?.number_format){case"comma_decimal":return["en-US","en"];case"decimal_comma":return["de","es","it"];case"space_comma":return["fr","sv","cs"];case"quote_decimal":return["de-CH"];case"system":return void 0;case"none":return"en-US";default:return n?.language}}var Je=new Map;function y(n,e,t=1){const r=hn(e);const o=e?.number_format!=="none";const i=`${JSON.stringify(r)}|${t}|${o}`;let s=Je.get(i);if(!s){try{s=new Intl.NumberFormat(r,{minimumFractionDigits:t,maximumFractionDigits:t,useGrouping:o})}catch{s=new Intl.NumberFormat(void 0,{minimumFractionDigits:t,maximumFractionDigits:t})}Je.set(i,s)}return s.format(n)}function be(n,e,t){return y(K(n,e),t)}function et(n,e,t){return y(un(n,e),t)}var pn=2;var mn=new Set(["active","cooling","heating","open","opening","overrun","ready","requested","running","selected","starting","waiting"]);function tt(n){if(!n||typeof n!=="object"){throw new Error("Hydronicus returned no Plant snapshot.")}const e=n;if(e.schema_version!==pn){throw new Error(`Unsupported Hydronicus snapshot schema: ${String(e.schema_version)}.`)}if(!e.plant||!Array.isArray(e.zones)||!Array.isArray(e.alerts)){throw new Error("Hydronicus returned an incomplete Plant snapshot.")}return e}function nt(n){return[...n.alerts].sort((e,t)=>e.priority-t.priority||e.code.localeCompare(t.code)||e.scope.localeCompare(t.scope))}function rt(n){const e=n.plant.health.toLowerCase();const t=n.alerts.some(o=>o.severity==="critical"||o.severity==="error");if(n.safe_shutdown.active||t||["blocked","critical","error","failed","unhealthy"].includes(e)){return"attention"}const r=`${n.plant.active_mode} ${n.plant.status}`.toLowerCase();if(r.includes("cool"))return"cooling";if(r.includes("heat"))return"heating";return"idle"}function ot(n){if(n.blocked)return"attention";if(n.cooling.demand)return"cooling";if(n.demand)return"heating";return"idle"}function ve(n){return mn.has(n.toLowerCase())}function G(n){if(!n)return"none";return n.cooling.demand?"cooling":n.demand?"heating":"none"}function it(n,e){if(n.thermostat.kind!=="hydronicus"||!n.thermostat.control_entity_id)return null;return{domain:"climate",service:"set_temperature",data:{entity_id:n.thermostat.control_entity_id,temperature:e}}}function st(n,e){if(n.thermostat.kind!=="hydronicus"||!n.thermostat.control_entity_id)return null;return{domain:"climate",service:"set_preset_mode",data:{entity_id:n.thermostat.control_entity_id,preset_mode:e}}}function at(n,e){if(n.thermostat.kind!=="hydronicus"||!n.thermostat.control_entity_id)return null;if(!xe(n).includes(e))return null;return{domain:"climate",service:"set_hvac_mode",data:{entity_id:n.thermostat.control_entity_id,hvac_mode:e}}}function lt(n,e){if(!n.controls.requested_mode)return null;return{domain:"select",service:"select_option",data:{entity_id:n.controls.requested_mode,option:e}}}function ct(n){if(!n.controls.safe_shutdown)return null;return{domain:"button",service:"press",data:{entity_id:n.controls.safe_shutdown}}}function dt(n){const e=String(n.action??"operation").replaceAll("_"," ");const t=String(n.actuator_name??"actuator");const r=String(n.result??"");if(r==="proposed")return`Would ${e} ${t}`;if(r==="executed")return`Executed ${t} ${e}`;if(r==="suppressed")return`Suppressed ${t} ${e}`;return`${r||"Operation"}: ${t} ${e}`}function fn(n){return n.replaceAll("_"," ")}function N(n,e,t){const[r,o]=e.split(".");return n?.(`component.hydronicus.entity.${r}.${o}.state.${t}`)||f(t)}function f(n){const e=fn(n);return e.charAt(0).toUpperCase()+e.slice(1)}var gn={off:"Off",heat:"Heat",cool:"Cool",heat_cool:"Heat/Cool",auto:"Auto"};function _e(n,e){return n?.(`component.climate.entity_component._.state.${e}`)||gn[e]||f(e)}function xe(n){if(n.thermostat.kind!=="hydronicus")return[];return[...new Set(n.thermostat.hvac_modes??[])]}function we(n){if(n.dry_run||n.mode==="dry_run")return"Dry run";if(n.mode==="mixed"&&!n.forced_shadow.length)return"Live";return f(n.mode)}function ut(n){if(n.dry_run||n.mode==="dry_run")return"dry-run";if(n.mode==="mixed"&&!n.forced_shadow.length)return"live";return n.mode.replaceAll("_","-")}function ht(n){const{active_name:e,recommended_name:t}=n.plant.source;if(!n.sources.length&&!e&&!t)return null;const r=[e??"None active"];if(t&&t!==e)r.push(`recommended ${t}`);return r.join(" \xB7 ")}var yn={zone:"Zone",circuit:"Loop"};var bn={plant_initializing:"Starting",plant_unavailable:"Plant unavailable",binding_unavailable:"Entity unavailable",zone_sensor_blocked:"Sensor blocked",zone_mode_blocked:"Zone blocked",cooling_blocked:"Cooling blocked",actuator_mismatch:"Equipment mismatch",actuator_blocked:"Equipment blocked",mode_changeover:"Mode changeover"};function pt(n){const e=bn[n.code]??f(n.code);return n.scope!=="plant"&&n.name?`${n.name} \xB7 ${e}`:e}function $e(n){return yn[n]??f(n)}function mt(n){return[...new Set(n.thermostat.preset_modes)].filter(e=>e!=="none")}function ft(n,e,t=C){if(n.thermostat.target_temperature===null)return null;return Qe(n.thermostat.target_temperature,e,t)}var vn="hydronicus/subscribe_plant";var _n=1e3;var xn=6e4;var wn={setTimeout:(n,e)=>globalThis.setTimeout(n,e),clearTimeout:n=>globalThis.clearTimeout(n)};var gt={plant_not_found:"not_found",unauthorized:"unauthorized"};function yt(n){return n!==void 0&&Object.hasOwn(gt,n)?gt[n]:void 0}function $n(n){return typeof n==="object"&&n!==null&&"code"in n?String(n.code):void 0}function D(n,e){if(n instanceof Error)return n.message;if(typeof n==="object"&&n!==null&&"message"in n&&n.message){return String(n.message)}return e}function ke(n){if(!n)return;try{void Promise.resolve(n()).catch(()=>void 0)}catch{}}var X=class{constructor(e,t=wn){this.host=e;this.scheduler=t}host;scheduler;connection;plantId;generation=0;unsubscribe;retryHandle;attempt=0;current={kind:"idle"};get status(){return this.current}connect(e,t){if(e===this.connection&&t===this.plantId)return;this.disconnect();if(!e||!t)return;this.connection=e;this.plantId=t;e.addEventListener?.("disconnected",this.handleDisconnected);e.addEventListener?.("ready",this.handleReady);this.subscribe()}disconnect(){this.cancelRetry();this.generation+=1;ke(this.unsubscribe);this.unsubscribe=void 0;this.connection?.removeEventListener?.("disconnected",this.handleDisconnected);this.connection?.removeEventListener?.("ready",this.handleReady);this.connection=void 0;this.plantId=void 0;this.attempt=0;this.setStatus({kind:"idle"})}subscribe(){const e=this.connection;const t=this.plantId;if(!e||!t)return;this.cancelRetry();const r=++this.generation;if(this.current.kind!=="reconnecting"&&this.current.kind!=="retrying"){this.setStatus({kind:"connecting"})}e.subscribeMessage(o=>this.handleEvent(r,o),{type:vn,plant_id:t},{resubscribe:false}).then(o=>{if(r!==this.generation){ke(o);return}this.unsubscribe=o}).catch(o=>{if(r!==this.generation)return;this.handleError(o)})}handleEvent(e,t){if(e!==this.generation)return;if(t.snapshot!==void 0&&t.snapshot!==null){this.attempt=0;this.setStatus({kind:"live"});this.host.onSnapshot(t.snapshot);return}if(t.status==="unavailable"){this.setStatus({kind:"unavailable"});return}const r=yt(t.status);if(r)this.stop({kind:r})}handleError(e){const t=yt($n(e));if(t){this.stop({kind:t});return}const r=Math.min(_n*2**this.attempt,xn);this.attempt+=1;this.setStatus({kind:"retrying",attempt:this.attempt,delayMs:r,message:D(e,"The Hydronicus Plant stream failed.")});this.retryHandle=this.scheduler.setTimeout(()=>{this.retryHandle=void 0;this.subscribe()},r)}stop(e){this.cancelRetry();this.generation+=1;ke(this.unsubscribe);this.unsubscribe=void 0;this.setStatus(e)}handleDisconnected=()=>{this.cancelRetry();this.generation+=1;this.unsubscribe=void 0;this.setStatus({kind:"reconnecting"})};handleReady=()=>{this.attempt=0;this.subscribe()};cancelRetry(){if(this.retryHandle!==void 0)this.scheduler.clearTimeout(this.retryHandle);this.retryHandle=void 0}setStatus(e){this.current=e;this.host.onStatus(e)}};var T={status:{kind:"idle"},snapshot:null,snapshotError:null};var kn=new Set(["idle","unavailable","not_found","unauthorized"]);var Se=class{listeners=new Set;current=T;stream;constructor(e){this.stream=new X({onStatus:t=>this.statusChanged(t),onSnapshot:t=>this.snapshotReceived(t)},e)}get state(){return this.current}open(e,t){this.stream.connect(e,t)}close(){this.stream.disconnect()}statusChanged(e){const t=kn.has(e.kind)?null:this.current.snapshot;this.publish({...this.current,status:e,snapshot:t})}snapshotReceived(e){try{this.publish({...this.current,snapshot:tt(e),snapshotError:null})}catch(t){this.publish({...this.current,snapshot:null,snapshotError:D(t,"Unsupported Hydronicus snapshot.")})}}publish(e){this.current=e;for(const t of[...this.listeners])t(e)}};var Ce=class{constructor(e){this.scheduler=e}scheduler;feeds=new WeakMap;subscribe(e,t,r){let o=this.feeds.get(e);if(!o){o=new Map;this.feeds.set(e,o)}let i=o.get(t);const s=!i;if(!i){i=new Se(this.scheduler);o.set(t,i)}i.listeners.add(r);if(s)i.open(e,t);else r(i.state);const u=o;const l=i;let d=false;return()=>{if(d)return;d=true;l.listeners.delete(r);if(l.listeners.size)return;queueMicrotask(()=>{if(l.listeners.size||u.get(t)!==l)return;u.delete(t);l.close()})}}snapshot(e,t,r=2e3){return new Promise(o=>{let i=false;const s=d=>{if(i)return;i=true;clearTimeout(u);queueMicrotask(()=>l());o(d)};const u=setTimeout(()=>s(null),r);const l=this.subscribe(e,t,d=>{if(d.snapshot)s(d.snapshot);else if(["not_found","unauthorized"].includes(d.status.kind)||d.snapshotError)s(null)})})}};var H=new Ce;var Y="hydronicus-plant-card";var bt=`custom:${Y}`;var J="hydronicus-zone-card";var vt=`custom:${J}`;var Q="hydronicus-zone-card-editor";var Sn="hydronicus/list_plants";var Cn=["comfortable","compact"];var _t=[{value:"header",label:"Header and execution boundary"},{value:"alerts",label:"Alerts"},{value:"zones",label:"Zones"},{value:"paths",label:"Hydraulic flow"},{value:"equipment",label:"Equipment"},{value:"explanations",label:"Controller explanations"},{value:"operations",label:"Operation outcomes"}];var Ae=_t.map(n=>n.value);function xt(n,e,t){if(!n||typeof n!=="object"){throw new Error(`${e} requires a configuration.`)}const r=n;if(r.type!==t){throw new Error(`${e} type must be ${t}.`)}if(typeof r.plant!=="string"){throw new Error(`${e} requires one Plant UUID in \`plant\`.`)}return r}function wt(n,e){const t=n??"comfortable";if(!Cn.includes(t)){throw new Error(`${e} density must be comfortable or compact.`)}return t}function An(n){if(n===void 0||n===null)return void 0;if(!Array.isArray(n)){throw new Error("Hydronicus Plant card `sections` must be a list of section names.")}const e=new Set;for(const t of n){if(typeof t!=="string"||!Ae.includes(t)){throw new Error(`Hydronicus Plant card section ${JSON.stringify(t)} is unknown. Use ${Ae.join(", ")}.`)}if(e.has(t)){throw new Error(`Hydronicus Plant card section ${t} is listed twice.`)}e.add(t)}return n.length?n:void 0}function ze(n){const e="Hydronicus Plant card";const t=xt(n,e,bt);const r=wt(t.density,e);const o=An(t.sections);return{type:bt,plant:t.plant.trim(),density:r,...o?{sections:o}:{}}}function ee(n){return n?.sections??Ae}function te(n){const e="Hydronicus Zone card";const t=xt(n,e,vt);const r=t.zone??"";if(typeof r!=="string"){throw new Error(`${e} requires one Zone id in \`zone\`.`)}const o=wt(t.density,e);return{type:vt,plant:t.plant.trim(),zone:r.trim(),density:o}}var Ee=class{plants=[];pending=null;connection=null;get known(){return this.plants}load(e){if(this.connection===e&&this.pending)return this.pending;this.connection=e;this.pending=e.sendMessagePromise({type:Sn}).then(t=>{this.plants=Array.isArray(t.plants)?t.plants:[];return this.plants}).catch(()=>{if(this.connection===e)this.pending=null;return this.plants});return this.pending}async settled(e=2e3){if(!this.pending)return this.plants;let t;const r=new Promise(o=>{t=setTimeout(()=>o(this.plants),e)});try{return await Promise.race([this.pending,r])}finally{clearTimeout(t)}}reset(){this.plants=[];this.pending=null;this.connection=null}};var v=new Ee;async function $t(n){const e=n?.connection?await v.load(n.connection):v.known;return{plant:e[0]?.id??"",density:"comfortable"}}async function kt(n){const e=n?.connection;const t=e?await v.load(e):v.known;const r=t[0]?.id??"";const o=e&&r?await H.snapshot(e,r):null;return{plant:r,zone:o?.zones[0]?.id??"",density:"comfortable"}}var En={plant:"Hydronicus Plant",zone:"Zone",density:"Density",sections:"Sections"};var Pn={plant:"The Plant this card shows. Only Plants you can read are listed; one that is not listed shows its UUID.",zone:"The Zone this card shows. Only Zones you can read are listed; one that is not listed shows its id.",density:"Compact uses less spacing for dense dashboards.",sections:"The parts of the Plant to show, in this order. Leave empty to show every section."};var Re=n=>En[n.name];var Te=n=>Pn[n.name];function Pe(n){if(n.length===0)return{text:{}};return{select:{mode:"dropdown",options:n.map(e=>({value:e.id,label:e.name}))}}}var St={name:"density",selector:{select:{mode:"dropdown",options:[{value:"comfortable",label:"Comfortable"},{value:"compact",label:"Compact"}]}}};async function Ct(){const n=await v.settled();return{schema:[{name:"plant",required:true,selector:Pe(n)},St,{name:"sections",selector:{select:{multiple:true,reorder:true,mode:"dropdown",options:_t.map(e=>({...e}))}}}],computeLabel:Re,computeHelper:Te,assertConfig:e=>{ze(e)}}}function At(n,e){return[{name:"plant",required:true,selector:Pe(n)},{name:"zone",required:true,selector:Pe(e)},St]}var ne=globalThis;var re=ne.ShadowRoot&&(void 0===ne.ShadyCSS||ne.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype;var He=Symbol();var Et=new WeakMap;var Z=class{constructor(e,t,r){if(this._$cssResult$=true,r!==He)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(re&&void 0===e){const r=void 0!==t&&1===t.length;r&&(e=Et.get(t)),void 0===e&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&Et.set(t,e))}return e}toString(){return this.cssText}};var Pt=n=>new Z("string"==typeof n?n:n+"",void 0,He);var Le=(n,...e)=>{const t=1===n.length?n[0]:e.reduce((r,o,i)=>r+(s=>{if(true===s._$cssResult$)return s.cssText;if("number"==typeof s)return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+n[i+1],n[0]);return new Z(t,n,He)};var zt=(n,e)=>{if(re)n.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const t of e){const r=document.createElement("style"),o=ne.litNonce;void 0!==o&&r.setAttribute("nonce",o),r.textContent=t.cssText,n.appendChild(r)}};var Me=re?n=>n:n=>n instanceof CSSStyleSheet?(e=>{let t="";for(const r of e.cssRules)t+=r.cssText;return Pt(t)})(n):n;var{is:zn,defineProperty:Rn,getOwnPropertyDescriptor:Tn,getOwnPropertyNames:Hn,getOwnPropertySymbols:Ln,getPrototypeOf:Mn}=Object;var oe=globalThis;var Rt=oe.trustedTypes;var qn=Rt?Rt.emptyScript:"";var On=oe.reactiveElementPolyfillSupport;var I=(n,e)=>n;var qe={toAttribute(n,e){switch(e){case Boolean:n=n?qn:null;break;case Object:case Array:n=null==n?n:JSON.stringify(n)}return n},fromAttribute(n,e){let t=n;switch(e){case Boolean:t=null!==n;break;case Number:t=null===n?null:Number(n);break;case Object:case Array:try{t=JSON.parse(n)}catch(r){t=null}}return t}};var Ht=(n,e)=>!zn(n,e);var Tt={attribute:true,type:String,converter:qe,reflect:false,useDefault:false,hasChanged:Ht};Symbol.metadata??=Symbol("metadata"),oe.litPropertyMetadata??=new WeakMap;var w=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Tt){if(t.state&&(t.attribute=false),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=true),this.elementProperties.set(e,t),!t.noAccessor){const r=Symbol(),o=this.getPropertyDescriptor(e,r,t);void 0!==o&&Rn(this.prototype,e,o)}}static getPropertyDescriptor(e,t,r){const{get:o,set:i}=Tn(this.prototype,e)??{get(){return this[t]},set(s){this[t]=s}};return{get:o,set(s){const u=o?.call(this);i?.call(this,s),this.requestUpdate(e,u,r)},configurable:true,enumerable:true}}static getPropertyOptions(e){return this.elementProperties.get(e)??Tt}static _$Ei(){if(this.hasOwnProperty(I("elementProperties")))return;const e=Mn(this);e.finalize(),void 0!==e.l&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(I("finalized")))return;if(this.finalized=true,this._$Ei(),this.hasOwnProperty(I("properties"))){const t=this.properties,r=[...Hn(t),...Ln(t)];for(const o of r)this.createProperty(o,t[o])}const e=this[Symbol.metadata];if(null!==e){const t=litPropertyMetadata.get(e);if(void 0!==t)for(const[r,o]of t)this.elementProperties.set(r,o)}this._$Eh=new Map;for(const[t,r]of this.elementProperties){const o=this._$Eu(t,r);void 0!==o&&this._$Eh.set(o,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const r=new Set(e.flat(1/0).reverse());for(const o of r)t.unshift(Me(o))}else void 0!==e&&t.push(Me(e));return t}static _$Eu(e,t){const r=t.attribute;return false===r?void 0:"string"==typeof r?r:"string"==typeof e?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=false,this.hasUpdated=false,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),void 0!==this.renderRoot&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const r of t.keys())this.hasOwnProperty(r)&&(e.set(r,this[r]),delete this[r]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return zt(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(true),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,r){this._$AK(e,r)}_$ET(e,t){const r=this.constructor.elementProperties.get(e),o=this.constructor._$Eu(e,r);if(void 0!==o&&true===r.reflect){const i=(void 0!==r.converter?.toAttribute?r.converter:qe).toAttribute(t,r.type);this._$Em=e,null==i?this.removeAttribute(o):this.setAttribute(o,i),this._$Em=null}}_$AK(e,t){const r=this.constructor,o=r._$Eh.get(e);if(void 0!==o&&this._$Em!==o){const i=r.getPropertyOptions(o),s="function"==typeof i.converter?{fromAttribute:i.converter}:void 0!==i.converter?.fromAttribute?i.converter:qe;this._$Em=o;const u=s.fromAttribute(t,i.type);this[o]=u??this._$Ej?.get(o)??u,this._$Em=null}}requestUpdate(e,t,r,o=false,i){if(void 0!==e){const s=this.constructor;if(false===o&&(i=this[e]),r??=s.getPropertyOptions(e),!((r.hasChanged??Ht)(i,t)||r.useDefault&&r.reflect&&i===this._$Ej?.get(e)&&!this.hasAttribute(s._$Eu(e,r))))return;this.C(e,t,r)}false===this.isUpdatePending&&(this._$ES=this._$EP())}C(e,t,{useDefault:r,reflect:o,wrapped:i},s){r&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,s??t??this[e]),true!==i||void 0!==s)||(this._$AL.has(e)||(this.hasUpdated||r||(t=void 0),this._$AL.set(e,t)),true===o&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=true;try{await this._$ES}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return null!=e&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[o,i]of this._$Ep)this[o]=i;this._$Ep=void 0}const r=this.constructor.elementProperties;if(r.size>0)for(const[o,i]of r){const{wrapped:s}=i,u=this[o];true!==s||this._$AL.has(o)||void 0===u||this.C(o,void 0,i,u)}}let e=false;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(r=>r.hostUpdate?.()),this.update(t)):this._$EM()}catch(r){throw e=false,this._$EM(),r}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=true,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=false}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return true}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};w.elementStyles=[],w.shadowRootOptions={mode:"open"},w[I("elementProperties")]=new Map,w[I("finalized")]=new Map,On?.({ReactiveElement:w}),(oe.reactiveElementVersions??=[]).push("2.1.2");var Fe=globalThis;var Lt=n=>n;var ie=Fe.trustedTypes;var Mt=ie?ie.createPolicy("lit-html",{createHTML:n=>n}):void 0;var Zt="$lit$";var k=`lit$${Math.random().toFixed(9).slice(2)}$`;var It="?"+k;var Un=`<${It}>`;var P=document;var V=()=>P.createComment("");var j=n=>null===n||"object"!=typeof n&&"function"!=typeof n;var Ve=Array.isArray;var Nn=n=>Ve(n)||"function"==typeof n?.[Symbol.iterator];var Oe="[ 	\n\f\r]";var F=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;var qt=/-->/g;var Ot=/>/g;var A=RegExp(`>|${Oe}(?:([^\\s"'>=/]+)(${Oe}*=${Oe}*(?:[^
\f\r"'\`<>=]|("|')|))|$)`,"g");var Ut=/'/g;var Nt=/"/g;var Ft=/^(?:script|style|textarea|title)$/i;var je=n=>(e,...t)=>({_$litType$:n,strings:e,values:t});var a=je(1);var gr=je(2);var yr=je(3);var z=Symbol.for("lit-noChange");var c=Symbol.for("lit-nothing");var Dt=new WeakMap;var E=P.createTreeWalker(P,129);function Vt(n,e){if(!Ve(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==Mt?Mt.createHTML(e):e}var Dn=(n,e)=>{const t=n.length-1,r=[];let o,i=2===e?"<svg>":3===e?"<math>":"",s=F;for(let u=0;u<t;u++){const l=n[u];let d,p,h=-1,m=0;for(;m<l.length&&(s.lastIndex=m,p=s.exec(l),null!==p);)m=s.lastIndex,s===F?"!--"===p[1]?s=qt:void 0!==p[1]?s=Ot:void 0!==p[2]?(Ft.test(p[2])&&(o=RegExp("</"+p[2],"g")),s=A):void 0!==p[3]&&(s=A):s===A?">"===p[0]?(s=o??F,h=-1):void 0===p[1]?h=-2:(h=s.lastIndex-p[2].length,d=p[1],s=void 0===p[3]?A:'"'===p[3]?Nt:Ut):s===Nt||s===Ut?s=A:s===qt||s===Ot?s=F:(s=A,o=void 0);const g=s===A&&n[u+1].startsWith("/>")?" ":"";i+=s===F?l+Un:h>=0?(r.push(d),l.slice(0,h)+Zt+l.slice(h)+k+g):l+k+(-2===h?u:g)}return[Vt(n,i+(n[t]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),r]};var B=class n{constructor({strings:e,_$litType$:t},r){let o;this.parts=[];let i=0,s=0;const u=e.length-1,l=this.parts,[d,p]=Dn(e,t);if(this.el=n.createElement(d,r),E.currentNode=this.el.content,2===t||3===t){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;null!==(o=E.nextNode())&&l.length<u;){if(1===o.nodeType){if(o.hasAttributes())for(const h of o.getAttributeNames())if(h.endsWith(Zt)){const m=p[s++],g=o.getAttribute(h).split(k),S=/([.?@])?(.*)/.exec(m);l.push({type:1,index:i,name:S[2],strings:g,ctor:"."===S[1]?Ne:"?"===S[1]?De:"@"===S[1]?Ze:M}),o.removeAttribute(h)}else h.startsWith(k)&&(l.push({type:6,index:i}),o.removeAttribute(h));if(Ft.test(o.tagName)){const h=o.textContent.split(k),m=h.length-1;if(m>0){o.textContent=ie?ie.emptyScript:"";for(let g=0;g<m;g++)o.append(h[g],V()),E.nextNode(),l.push({type:2,index:++i});o.append(h[m],V())}}}else if(8===o.nodeType)if(o.data===It)l.push({type:2,index:i});else{let h=-1;for(;-1!==(h=o.data.indexOf(k,h+1));)l.push({type:7,index:i}),h+=k.length-1}i++}}static createElement(e,t){const r=P.createElement("template");return r.innerHTML=e,r}};function L(n,e,t=n,r){if(e===z)return e;let o=void 0!==r?t._$Co?.[r]:t._$Cl;const i=j(e)?void 0:e._$litDirective$;return o?.constructor!==i&&(o?._$AO?.(false),void 0===i?o=void 0:(o=new i(n),o._$AT(n,t,r)),void 0!==r?(t._$Co??=[])[r]=o:t._$Cl=o),void 0!==o&&(e=L(n,o._$AS(n,e.values),o,r)),e}var Ue=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:r}=this._$AD,o=(e?.creationScope??P).importNode(t,true);E.currentNode=o;let i=E.nextNode(),s=0,u=0,l=r[0];for(;void 0!==l;){if(s===l.index){let d;2===l.type?d=new W(i,i.nextSibling,this,e):1===l.type?d=new l.ctor(i,l.name,l.strings,this,e):6===l.type&&(d=new Ie(i,this,e)),this._$AV.push(d),l=r[++u]}s!==l?.index&&(i=E.nextNode(),s++)}return E.currentNode=P,o}p(e){let t=0;for(const r of this._$AV)void 0!==r&&(void 0!==r.strings?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}};var W=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,r,o){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=o,this._$Cv=o?.isConnected??true}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=L(this,e,t),j(e)?e===c||null==e||""===e?(this._$AH!==c&&this._$AR(),this._$AH=c):e!==this._$AH&&e!==z&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):Nn(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==c&&j(this._$AH)?this._$AA.nextSibling.data=e:this.T(P.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:r}=e,o="number"==typeof r?this._$AC(e):(void 0===r.el&&(r.el=B.createElement(Vt(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===o)this._$AH.p(t);else{const i=new Ue(o,this),s=i.u(this.options);i.p(t),this.T(s),this._$AH=i}}_$AC(e){let t=Dt.get(e.strings);return void 0===t&&Dt.set(e.strings,t=new B(e)),t}k(e){Ve(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let r,o=0;for(const i of e)o===t.length?t.push(r=new n(this.O(V()),this.O(V()),this,this.options)):r=t[o],r._$AI(i),o++;o<t.length&&(this._$AR(r&&r._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(false,true,t);e!==this._$AB;){const r=Lt(e).nextSibling;Lt(e).remove(),e=r}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}};var M=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,r,o,i){this.type=1,this._$AH=c,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=i,r.length>2||""!==r[0]||""!==r[1]?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=c}_$AI(e,t=this,r,o){const i=this.strings;let s=false;if(void 0===i)e=L(this,e,t,0),s=!j(e)||e!==this._$AH&&e!==z,s&&(this._$AH=e);else{const u=e;let l,d;for(e=i[0],l=0;l<i.length-1;l++)d=L(this,u[r+l],t,l),d===z&&(d=this._$AH[l]),s||=!j(d)||d!==this._$AH[l],d===c?e=c:e!==c&&(e+=(d??"")+i[l+1]),this._$AH[l]=d}s&&!o&&this.j(e)}j(e){e===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}};var Ne=class extends M{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===c?void 0:e}};var De=class extends M{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==c)}};var Ze=class extends M{constructor(e,t,r,o,i){super(e,t,r,o,i),this.type=5}_$AI(e,t=this){if((e=L(this,e,t,0)??c)===z)return;const r=this._$AH,o=e===c&&r!==c||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,i=e!==c&&(r===c||o);o&&this.element.removeEventListener(this.name,this,r),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}};var Ie=class{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){L(this,e)}};var Zn=Fe.litHtmlPolyfillSupport;Zn?.(B,W),(Fe.litHtmlVersions??=[]).push("3.3.3");var jt=(n,e,t)=>{const r=t?.renderBefore??e;let o=r._$litPart$;if(void 0===o){const i=t?.renderBefore??null;r._$litPart$=o=new W(e.insertBefore(V(),i),i,void 0,t??{})}return o._$AI(n),o};var Be=globalThis;var _=class extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=jt(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(true)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(false)}render(){return z}};_._$litElement$=true,_["finalized"]=true,Be.litElementHydrateSupport?.({LitElement:_});var In=Be.litElementPolyfillSupport;In?.({LitElement:_});(Be.litElementVersions??=[]).push("4.2.2");var R=class extends Event{constructor(e,t,r,o){super("context-request",{bubbles:true,composed:true}),this.context=e,this.contextTarget=t,this.callback=r,this.subscribe=o??false}};function q(n){return n}var $=class{constructor(e,t,r,o){if(this.subscribe=false,this.provided=false,this.value=void 0,this.t=(i,s)=>{this.unsubscribe&&(this.unsubscribe!==s&&(this.provided=false,this.unsubscribe()),this.subscribe||this.unsubscribe()),this.value=i,this.host.requestUpdate(),this.provided&&!this.subscribe||(this.provided=true,this.callback&&this.callback(i,s)),this.unsubscribe=s},this.host=e,void 0!==t.context){const i=t;this.context=i.context,this.callback=i.callback,this.subscribe=i.subscribe??false}else this.context=t,this.callback=r,this.subscribe=o??false;this.host.addController(this)}hostConnected(){this.dispatchRequest()}hostDisconnected(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=void 0)}dispatchRequest(){this.host.dispatchEvent(new R(this.context,this.host,this.t,this.subscribe))}};var Bt=Le`
  :host {
    display: block;
...
`;var Vn=q("hassConnection");var jn=q("hassApi");var Bn=q("hassConfig");var Wn=q("hassInternationalization");var O=class extends _{static properties={preview:{type:Boolean},_connection:{state:true},_unit:{state:true},_locale:{state:true},_localize:{state:true},_plant:{state:true},_actionError:{state:true}};static styles=Bt;_hass;_callService;_fromContext=new Set;_release;_followed;constructor(){super();this.preview=false;this._connection=void 0;this._unit=C;this._locale=void 0;this._localize=void 0;this._plant=T;this._actionError=null;new $(this,{context:Vn,subscribe:true,callback:e=>{this._fromContext.add("connection");this._connection=e?.connection}});new $(this,{context:jn,subscribe:true,callback:e=>{this._fromContext.add("api");this._callService=e?.callService}});new $(this,{context:Bn,subscribe:true,callback:e=>{this._fromContext.add("config");this._unit=ge(e?.config?.unit_system)}});new $(this,{context:Wn,subscribe:true,callback:e=>{this._fromContext.add("i18n");this._locale=e?.locale??(e?.language?{language:e.language}:void 0);this._localize=e?.localize}})}set hass(e){this._hass=e;if(!this._fromContext.has("connection"))this._connection=e?.connection;if(!this._fromContext.has("api"))this._callService=e?(...t)=>e.callService(...t):void 0;if(!this._fromContext.has("config"))this._unit=ge(e?.config?.unit_system);if(!this._fromContext.has("i18n")){this._locale=e?.locale??(e?.language?{language:e.language}:void 0);this._localize=e?.localize}}get hass(){return this._hass}resetPlant(){this._plant=T;this._actionError=null}connectedCallback(){super.connectedCallback();this._follow()}disconnectedCallback(){this._unfollow();super.disconnectedCallback()}updated(e){super.updated(e);this._syncSelectValues();if(!this.isConnected)return;this._follow();if(this._connection&&(e.has("_connection")||this.preview))void v.load(this._connection)}_follow(){const e=this._connection;const t=this.plantId||void 0;const r=this._followed;if(r&&r.connection===e&&r.plantId===t)return;this._unfollow();if(!e||!t)return;this._followed={connection:e,plantId:t};this._release=H.subscribe(e,t,o=>{this._plant=o;this.plantStateChanged?.(o)})}_unfollow(){this._release?.();this._release=void 0;this._followed=void 0;this._plant=T;this.plantStateChanged?.(T)}_syncSelectValues(){for(const e of this.renderRoot.querySelectorAll("select[data-value]")){const t=e.dataset.value??"";if(e.value!==t)e.value=t}}get renderContext(){return{unit:this._unit,locale:this._locale,localize:this._localize,moreInfo:e=>this.moreInfo(e),call:e=>this.call(e)}}moreInfo(e){this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:true,composed:true,detail:{entityId:e}}))}call(e){const t=this._callService;if(!e||!t)return;t(e.domain,e.service,e.data,void 0,false).then(()=>{this._actionError=null},r=>{this._actionError=D(r,"The Home Assistant action failed.");this.requestUpdate()})}dismissActionError=()=>{this._actionError=null}};function Wt(n,e,t,r){const o=n.unit;if(e===null){return a`<div class=${r} part="metric"><span class="metric-value">--</span><span class="metric-label">${t}<span class="visually-hidden"> unavailable</span></span></div>`}return a`<div class=${r} part="metric"><span class="metric-value">${be(e,o,n.locale)}</span><span class="metric-unit">${o}</span><span class="metric-label">${t}</span></div>`}function Kt(n,e,t){const r=ft(e,t,n.unit);if(r!==null)n.call(it(e,r))}function Kn(n,e,t){if(t===e.thermostat.hvac_mode)return;n.call(at(e,t))}function Gn(n,e,t){n.call(st(e,t.target.value))}function se(n,e,t){const r=e.thermostat;const o=r.kind==="hydronicus";const i=G(e);const s=i!=="none";const u=r.hvac_mode==="off";const{unit:l,locale:d,localize:p}=n;const h=y(ye(l),d,l===C?1:0);const m=r.control_entity_id;const g=Boolean(m)&&r.target_temperature!==null;const S=mt(e);const Ge=xe(e);const me=r.hvac_mode?_e(p,r.hvac_mode):null;const an=u&&!e.blocked?me??"Off":f(e.phase);const Xe=s?`${i==="cooling"?"Cooling":"Heating"} demand active`:u?"Thermostat off":"No demand";const fe=`zone-${e.id}`;const Ye=m?a`<button type="button" class="link" aria-haspopup="dialog" title="Show thermostat details" @click=${()=>n.moreInfo(m)}>${e.name}</button>`:e.name;const ln=t.headingLevel===2?a`<h2 class="zone-title" part="zone-title" id=${fe}>${Ye}</h2>`:a`<h4 class="zone-title" part="zone-title" id=${fe}>${Ye}</h4>`;return a`<article class="zone" part="zone" data-phase=${e.phase} data-hvac-mode=${r.hvac_mode??"unknown"} data-demand=${String(s)} data-demand-kind=${i} data-blocked=${String(e.blocked)} aria-labelledby=${fe}>
    <div class="row"><div>${ln}<p class="meta zone-owner">${o?"Hydronicus thermostat":`External thermostat \xB7 read-only${me?` \xB7 ${me}`:""}`}</p></div><span class=${`phase${e.blocked?" state blocked":""}${u?" off":""}`} part="badge">${an}</span></div>
    <div class="temperature-panel">
      ${Wt(n,r.current_temperature,"Current","metric")}
      ${Wt(n,r.target_temperature,"Target","metric target")}
    </div>
    <p class="meta zone-note" dir="auto">${o?Xe:`${Xe} \xB7 ${r.explanation}`}</p>
    <ul class="diagnostic-list" aria-label="Zone diagnostics">
      <li part="chip" class="diagnostic-chip" dir="auto">${y(e.sensor_status.usable,d,0)} sensor${e.sensor_status.usable===1?"":"s"} ready</li>
      ${e.sensor_status.optional_excluded?a`<li part="chip" class="diagnostic-chip warning" dir="auto">${y(e.sensor_status.optional_excluded,d,0)} optional excluded</li>`:c}
      ${e.sensor_status.required_blocking?a`<li part="chip" class="diagnostic-chip danger" dir="auto">${y(e.sensor_status.required_blocking,d,0)} required blocked</li>`:c}
      ${e.cooling.dew_point===null?c:a`<li part="chip" class="diagnostic-chip" dir="auto">Dew point ${be(e.cooling.dew_point,l,d)} ${l}</li>`}
      ${e.cooling.condensation_margin===null?c:a`<li part="chip" class="diagnostic-chip ${e.cooling.blocked?"danger":""}" dir="auto">Margin ${et(e.cooling.condensation_margin,l,d)} ${l}</li>`}
    </ul>
    ...
    ${e.coupling_group_ids.length?a`<p class="meta coupling-note" dir="auto">Coupled delivery - this Zone shares hydraulic equipment.</p>`:c}
    ${o?a`${Ge.length?a`<div class="hvac-modes" part="control" role="group" aria-label=${`${e.name} HVAC mode`}>${Ge.map(x=>a`<button type="button" class="hvac-mode" part="segment" data-mode=${x} aria-pressed=${String(x===r.hvac_mode)} ?disabled=${!m} @click=${()=>Kn(n,e,x)}>${_e(p,x)}</button>`)}</div>`:c}
          <div class="zone-actions" part="controls">
            <button type="button" part="control" dir="ltr" ?disabled=${!g} aria-label=${`Decrease ${e.name} target by ${h} ${l}`} @click=${()=>Kt(n,e,-1)}>−${h}</button>
            <button type="button" part="control" dir="ltr" ?disabled=${!g} aria-label=${`Increase ${e.name} target by ${h} ${l}`} @click=${()=>Kt(n,e,1)}>+${h}</button>
            ${S.length?a`<select class="preset" part="control" data-value=${r.preset??"none"} aria-label=${`${e.name} preset`} ?disabled=${!m} @change=${x=>Gn(n,e,x)}>${["none",...S].map(x=>a`<option value=${x}>${f(x)}</option>`)}</select>`:c}
          </div>`:a`<p class="meta" dir="auto">Adjust this thermostat in its owning Home Assistant integration.</p>`}
  </article>`}var We=["auto","idle","heating","cooling"];function Xn(n,e){const t=e.plant;const r=`Mode ${N(n.localize,"select.requested_mode",t.requested_mode)}`;if(t.requested_mode==="auto"||t.requested_mode===t.active_mode)return r;return`${r} \xB7 now ${N(n.localize,"sensor.operating_mode",t.active_mode)}`}function Gt(n,e,t){const r=e.plant;const o=r.execution_boundary;const i=e.controls.requested_mode;const s=We.includes(r.requested_mode)?We:[...We,r.requested_mode];const u=ht(e);const l=d=>n.call(lt(e,d.target.value));return a`<header class="header" part="header">
      <div class="plant-heading">
        ...
        <div class="header-copy">
          ...
          <div class="status-line" part="status">
            ...
            <span class="meta mode-detail">${Xn(n,e)}</span>
          </div>
      ...
      <div class="controls" part="controls">
        <span class="badge ${ut(o)}" part="badge"><span class="visually-hidden">Execution boundary: </span>${we(o)}</span>
    ...
    </header>`}function Xt(n){return a`<div class="boundary" part="boundary" role="status">
      <span class="boundary-orb" aria-hidden="true"></span>
      <p class="boundary-copy" dir="auto"><span class="control-label">Execution boundary</span><strong>${n.plant.execution_boundary.message||`${we(n.plant.execution_boundary)} execution boundary is active.`}</strong></p>
    </div>`}function Yt(n,e){const t=nt(e);if(!t.length)return c;return a`<section part="section" aria-labelledby="hydronicus-alerts"><div class="section-head"><div class="section-kicker"><h3 part="section-title" id="hydronicus-alerts">Alerts</h3></div><span class="meta" dir="auto">${y(t.length,n.locale,0)}</span></div>${t.slice(0,3).map(r=>{const o=r.severity==="error"||r.severity==="critical";return a`<p class="alert ${o?"error":""}" part="notice" data-severity=${r.severity} dir="auto"><strong>${pt(r)}</strong><span> · ${r.message}</span></p>`})}</section>`}function Jt(n,e){return a`<section part="section" aria-labelledby="hydronicus-zones"><div class="section-head"><div class="section-kicker"><h3 part="section-title" id="hydronicus-zones">Zones</h3></div><span class="meta" dir="auto">${y(e.zones.length,n.locale,0)} visible</span></div><div class="zone-grid">${e.zones.length?e.zones.map(t=>se(n,t,{headingLevel:4})):a`<p class="muted empty-state" dir="auto">No Zones are visible for this Plant.</p>`}</div></section>`}function Qt(n){if(!n.delivery_paths.length)return c;return a`<section part="section" aria-labelledby="hydronicus-paths"><div class="section-head"><div class="section-kicker"><h3 part="section-title" id="hydronicus-paths">Hydraulic Flow</h3></div><span class="meta" dir="auto">Zone → Loop → Valve → Pump → Source</span></div><div class="path-list">${n.delivery_paths.map(e=>{const t=n.zones.find(r=>r.id===e.zone_id);return a`<article class="path" part="path" data-status=${e.status} data-flowing=${String(ve(e.status))} data-demand-kind=${G(t)}>
    <div class="path-head"><div class="path-heading"><strong>${t?.name??e.zone_id}</strong></div><div class="status-line"><span class="state ${e.status}" part="badge">${f(e.status)}</span>${e.coupled?a`<span class="meta">shares equipment</span>`:c}</div></div>
    <ol class="path-track" aria-label="Ordered hydraulic delivery path">${e.nodes.map((r,o)=>a`<li class="path-step">${o?a`<span class="flow-link" aria-hidden="true"></span>`:c}<span class="node" part="node" data-kind=${r.kind} data-state=${r.state} data-flowing=${String(ve(r.state))}><span class="node-kind">${$e(r.kind)}</span><span class="node-name">${r.name}</span><span class="node-state">${f(r.state)}</span></span></li>`)}</ol>
    ${e.problem?a`<p class="meta path-problem" dir="auto">${e.problem}</p>`:c}
  </article>`})}</div></section>`}function en(n){if(!n.actuators.length)return c;return a`<section part="section" aria-labelledby="hydronicus-actuators"><div class="section-head"><div class="section-kicker"><h3 part="section-title" id="hydronicus-actuators">Equipment</h3></div><span class="meta" dir="auto">Loops using each valve and pump</span></div><div class="actuator-list">${n.actuators.map(e=>a`<article class="actuator" part="equipment" data-state=${e.state}><div class="row"><strong>${e.name}</strong><span class="state actuator-state ${e.state}" part="badge">${f(e.state)}</span></div><p class="meta" dir="auto">${f(e.kind)} · ${e.reason??"No additional explanation."}</p>${e.active_consumers.length?a`<ul class="consumer-list" aria-label="Loops using this equipment">${e.active_consumers.map(t=>a`<li class="consumer-chip" part="chip" title=${t.id}><strong>${t.name}</strong></li>`)}</ul>`:a`<p class="meta zone-note" dir="auto">No loop is using this right now.</p>`}</article>`)}</div></section>`}function tn(n){return a`<section part="section"><details part="disclosure"><summary>Controller explanations</summary>${n.explanations.map(e=>a`<div class="operation"><span class="operation-marker" aria-hidden="true"></span><p class="operation-copy" dir="auto"><strong>${e.name??$e(e.scope)}</strong> · ${e.message}</p></div>`)}</details></section>`}function nn(n,e){const t=Object.values(e.execution.operations).flat();if(!t.length)return c;return a`<section part="section"><details part="disclosure" open><summary>Latest operation outcomes (${y(t.length,n.locale,0)})</summary>${t.map(r=>{const o=String(r.result??"unknown");return a`<div class="operation" data-result=${o}><span class="operation-marker" aria-hidden="true"></span><p class="operation-copy" dir="auto"><strong>${dt(r)}</strong><br><span class="meta">${String(r.reason??r.explanation??"")}</span></p></div>`})}</details></section>`}function rn(n){return`Retrying in ${Math.round(n/1e3)} s.`}function b(n,e,t,r,o){return a`<ha-card part="card" class="state-card" data-visual=${r==="alert"?"attention":"idle"}>
    ...
    <p class="muted">${n?"Reconnecting to Home Assistant\u2026":"Loading Plant snapshot\u2026"}</p>
  </ha-card>`}function ae(n){return n.snapshotError?null:n.snapshot}function le(n,e){if(e.snapshotError){return b(n,"Card update needed",e.snapshotError,"alert","Reload the browser after upgrading Hydronicus so the card and the integration match.")}const t=e.status;switch(t.kind){case"not_found":return b(n,"Plant not found","This Hydronicus Plant was not found. Choose another Plant in the card editor.","alert");case"unauthorized":return b(n,"No access","You do not have access to this Hydronicus Plant.","alert");case"unavailable":return b(n,"Plant unavailable","The Hydronicus Plant is unavailable while it loads or after it was unloaded. The card reconnects automatically.","status");case"retrying":return b(n,"Connection needs attention",t.message,"alert",rn(t.delayMs));default:return Yn(t.kind==="reconnecting")}}function ce(n){if(n.kind==="reconnecting"){return a`<p class="notice" part="notice" role="status" dir="auto">Reconnecting to Home Assistant… The values below may be out of date.</p>`}if(n.kind==="retrying"){return a`<p class="notice" part="notice" role="status" dir="auto">${n.message} ${rn(n.delayMs)} The values below may be out of date.</p>`}return c}function de(n,e){if(!n)return c;return a`<div class="action-error" part="notice" role="alert"><span dir="auto">${n}</span><button type="button" part="control" @click=${e}>Dismiss</button></div>`}var Jn=1200;var Ke="Hydronicus Plant";var Qn=["zones","paths","equipment"];function er(n,e){switch(n){case"header":return 4;case"alerts":{const t=Math.min(e.alerts.length,3);return t?1+t:0}case"zones":return 1+Math.max(1,e.zones.length)*5;case"paths":return e.delivery_paths.length?1+e.delivery_paths.length*3:0;case"equipment":return e.actuators.length?1+e.actuators.length*2:0;case"explanations":return 1;case"operations":{const t=Object.values(e.execution.operations).flat().length;return t?1+t:0}}}var ue=class extends O{static properties={_config:{state:true},_holdingShutdown:{state:true}};_holdTimer=null;constructor(){super();this._config=void 0;this._holdingShutdown=false}static async getConfigForm(){return Ct()}static async getStubConfig(e){return $t(e)}setConfig(e){const t=ze(e);if(t.plant!==this._config?.plant)this.resetPlant();this._config=t}get plantId(){return this._config?.plant}getCardSize(){const e=this._plant.snapshot;const t=ee(this._config);if(!e)return t.includes("header")?4:2;return Math.max(1,t.reduce((r,o)=>r+er(o,e),0))}getGridOptions(){const e=ee(this._config).some(t=>Qn.includes(t));return e?{columns:12,min_columns:6}:{columns:6,min_columns:4}}disconnectedCallback(){this._clearHold();super.disconnectedCallback()}plantStateChanged(e){if(!e.snapshot)this._clearHold()}render(){const e=this._config;if(!e||!e.plant){return b(Ke,Ke,"Select a Hydronicus Plant in the card editor.","status")}const t=this._plant;const r=ae(t);if(!r)return le(Ke,t);const o=this.renderContext;const i=ee(e);const s=a`${ce(t.status)}${de(this._actionError,this.dismissActionError)}`;return a`<ha-card part="card" class=${e.density??"comfortable"} data-visual=${rt(r)}>
      ${i.includes("header")?c:s}
      ${i.map(u=>this._renderSection(u,o,r,s))}
    </ha-card>`}_renderSection(e,t,r,o){switch(e){case"header":return a`${Gt(t,r,this._renderShutdown(r))}
          ${o}
          ${Xt(r)}`;case"alerts":return Yt(t,r);case"zones":return Jt(t,r);case"paths":return Qt(r);case"equipment":return en(r);case"explanations":return tn(r);case"operations":return nn(t,r)}}_renderShutdown(e){const t=!e.controls.safe_shutdown;const r=e.plant.execution_boundary.dry_run;return a`<button type="button" part="control" class=${`shutdown${r?" quiet":""}${this._holdingShutdown?" is-holding":""}`} ?disabled=${t} aria-describedby="shutdown-hint"
      ...
      ${this._holdingShutdown?a`<span class="hold-progress" role="status">Keep holding…</span>`:c}`}_startHold(){if(!this._plant.snapshot||this._holdTimer!==null)return;this._holdingShutdown=true;this._holdTimer=setTimeout(()=>{this._holdTimer=null;this._holdingShutdown=false;const e=this._plant.snapshot;if(e)this.call(ct(e))},Jn)}_clearHold=()=>{if(this._holdTimer!==null)clearTimeout(this._holdTimer);this._holdTimer=null;this._holdingShutdown=false};_pointerHoldStart=e=>{if(e.button!==void 0&&e.button>0)return;this._startHold()};_keyHoldStart=e=>{if(e.key!=="Enter"&&e.key!==" ")return;e.preventDefault();if(!e.repeat)this._startHold()};_keyHoldEnd=e=>{if(e.key==="Enter"||e.key===" ")this._clearHold()};_preventContextMenu=e=>{e.preventDefault()}};var U="Hydronicus Zone";var he=class extends O{static properties={_config:{state:true}};constructor(){super();this._config=void 0}static getConfigElement(){return document.createElement(Q)}static async getStubConfig(e){return kt(e)}setConfig(e){const t=te(e);if(t.plant!==this._config?.plant)this.resetPlant();else if(t.zone!==this._config?.zone)this._actionError=null;this._config=t}get plantId(){return this._config?.zone?this._config.plant:void 0}getCardSize(){return 5}getGridOptions(){return{columns:6,min_columns:4}}render(){const e=this._config;if(!e||!e.plant){return b(U,U,"Select a Hydronicus Plant and a Zone in the card editor.","status")}if(!e.zone){return b(U,U,"Select a Zone in the card editor.","status")}const t=this._plant;const r=ae(t);if(!r)return le(U,t);const o=r.zones.find(i=>i.id===e.zone);if(!o){return b(U,"Zone not found","This Zone is not in the Plant, or you do not have access to it. Choose another Zone in the card editor.","alert")}return a`<ha-card part="card" class="zone-card ${e.density??"comfortable"}" data-visual=${ot(o)}>
      ${ce(t.status)}
      ${de(this._actionError,this.dismissActionError)}
      ${se(this.renderContext,o,{headingLevel:2})}
    </ha-card>`}};var pe=class extends _{static properties={hass:{attribute:false},_config:{state:true},_plants:{state:true},_zones:{state:true}};_release;_followed;_directoryConnection;constructor(){super();this.hass=void 0;this._config=void 0;this._plants=v.known;this._zones=[]}setConfig(e){te(e);this._config=e}connectedCallback(){super.connectedCallback();this.requestUpdate()}disconnectedCallback(){this._unfollow();this._directoryConnection=void 0;super.disconnectedCallback()}updated(e){super.updated(e);if(!this.isConnected)return;const t=this.hass?.connection;if(t&&t!==this._directoryConnection){this._directoryConnection=t;void v.load(t).then(r=>{this._plants=r})}this._follow(t,this._config?.plant||void 0)}_follow(e,t){const r=this._followed;if(r?.connection===e&&r?.plantId===t)return;this._unfollow();if(!e||!t)return;this._followed={connection:e,plantId:t};this._release=H.subscribe(e,t,o=>{if(o.snapshot)this._zones=o.snapshot.zones.map(i=>({id:i.id,name:i.name}))})}_unfollow(){this._release?.();this._release=void 0;this._followed=void 0;this._zones=[]}render(){return a`<ha-form
      .hass=${this.hass}
      .data=${this._config??{}}
      .schema=${At(this._plants,this._zones)}
      .computeLabel=${Re}
      .computeHelper=${Te}
      @value-changed=${this._valueChanged}
    ></ha-form>`}_valueChanged(e){e.stopPropagation();const t={...e.detail.value};if(t.plant!==this._config?.plant)t.zone="";this._config=t;this.dispatchEvent(new CustomEvent("config-changed",{bubbles:true,composed:true,detail:{config:t}}))}};var tr=[[Y,ue],[J,he],[Q,pe]];function on(n){for(const[e,t]of tr){if(!n.get(e))n.define(e,t)}}var sn=window.customElements;on(sn);void sn.whenDefined("home-assistant").then(()=>{on(window.customElements)});var nr=[{type:Y,name:"Hydronicus Plant",description:"Topology-driven Hydronicus Plant status and controls.",preview:false},{type:J,name:"Hydronicus Zone",description:"One Zone of a Hydronicus Plant, with its thermostat and controls.",preview:true}];window.customCards=window.customCards??[];for(const n of nr){if(window.customCards.some(e=>e.type===n.type))continue;window.customCards.push({...n,version:"0.1.0",documentationURL:"https://github.com/brumi1024/ha-hydronicus/blob/main/docs/lovelace.md"})}
